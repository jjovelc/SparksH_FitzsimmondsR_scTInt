...
rownames(mouse[["RNA"]]$counts) <- toupper(rownames(mouse[["RNA"]]$counts))
rownames(mouse[["RNA"]]$data) <- toupper(rownames(mouse[["RNA"]]$data))
rownames(mouse[["RNA"]]$scale.data) <- toupper(rownames(mouse[["RNA"]]$scale.data))
